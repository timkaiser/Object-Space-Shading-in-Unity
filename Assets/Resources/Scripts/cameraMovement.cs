...
public class cameraMovement : MonoBehaviour {
	...
	void Update () {
        ...
        MyPipeline.Log(Time.frameCount + "," + Time.time + "," + MyPipeline.pixelCountStat + "," + MyPipeline.tileCountStat + "," + cam.pixelWidth + "," + cam.pixelHeight + "," + MyPipeline.TILE_SIZE + "\n");
        ...
        progress += speed / distances[index - 1] * 1 / 30;//*Time.deltaTime;
        if(progress > 1) {
            progress = 0;
            index++;
        }
