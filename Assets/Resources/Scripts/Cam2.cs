...
public class Cam2 : MonoBehaviour {
    ...
    void Start() {
        ...
        this.colorBuffers = new RenderBuffer[3] { rts[0].colorBuffer, rts[1].colorBuffer, rts[2].colorBuffer /*, rts[3].colorBuffer*/};
        ...
        debugCS = (ComputeShader)Instantiate(Resources.Load("Shader/test"));
        CSkernel = debugCS.FindKernel("CSMain");

        debugCS.SetTexture(CSkernel, "Result", results);
        debugCS.SetTexture(CSkernel, "Input", rts[(int)RT.WorldPosition]);
