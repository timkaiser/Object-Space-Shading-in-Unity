...
public class Pipeline_OSS : RenderPipeline {
    //### variables ################################################################################################################
    ...
    public static void LogPixelStats() {
        ...
        output.Append(Time.frameCount).Append(",").Append(pixelCountStat).Append(",").Append(tileCountStat).Append(",").Append(cam.pixelWidth).Append(",").Append(cam.pixelHeight).Append(",").Append(TILE_SIZE).Append("\n");
    }
