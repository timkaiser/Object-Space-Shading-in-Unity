// This shader outputs the baycentric coordinates and the vertex ids of the mesh of a single object ﻿in uv-space
// It has to be called at the beginning of the program to compute an image of the baycentric cordinates and vertex ids every object.
// The scene has to be rendered once for every object with this shader.
